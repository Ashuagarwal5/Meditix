    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-10 py-10">
        ...
        >
          {/* Badge */}
          {badge && (
            <div className="inline-flex items-center gap-2 rounded-full bg-[#dbf9fd] px-3 py-1.5">
              <BadgeCheck
                size={12}
                strokeWidth={2.4}
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#0198ae]">
                {badge}
              </span>
            </div>
          )}
          ...
          {/* Title */}
          {title && (
            <h2 className="font-fraunces mt-4 text-[32px] sm:text-[38px] lg:text-[42px] font-semibold leading-[1.08] tracking-[-1.6px] lg:tracking-[-2px] text-[#071426] ">
              {title}
            </h2>
          )}
          ...
          {/* Description */}
          {description && (
            <p className="font-nunito mt-2 max-w-[570px] text-[16px] text-[#45566A] ">
              {description}
            </p>
          )}
        </motion.div>
        ...
        {/* =========================
            FAQ CONTENT
        ========================== */}
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-[0.8fr_1.15fr] items-start gap-8 lg:gap-12">
          {/* =========================
              LEFT IMAGE
          ========================== */}
          {image && (
            ...
            >
              <div className="relative overflow-hidden rounded-[12px] bg-white shadow-[0_4px_18px_rgba(18,54,85,0.08)]">
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  ...
                  className={` overflow-hidden rounded-[10px] border bg-white transition-all duration-300
                    ${
                      isOpen
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center justify-between gap-5 w-full bg-white px-5 sm:px-6 py-[12px]  text-left"
                  >
                    <span
                      className={`font-fraunces text-[16px] xl:text-[18px] font-semibold  w-full  
                        ${isOpen ? "text-[#0198ae]" : "text-gray-500"}`}
                    >
                      {faq.question}
                    </span>
                    ...
                    <motion.span
                      ...
                      className={` flex h-7 w-7 shrink-0
                        ...
                        ${
                          isOpen
                            ? "bg-[#0198ae] text-white"
                            : "bg-[#E4F7FA] text-[#0198ae]"
                        }
                      `}
                    >
                      {/* {isOpen ? (
                      ...
                      {isOpen ? (
                        <Plus
                          size={16}
                          strokeWidth={1.8}
                          className="font-nunito rotate-45 transition-all duration-300"
                        />
                      ) : (
                        <Plus size={16} strokeWidth={1.8} />
                      )}
                    ...
                    {isOpen && (
                      ...
                      >
                        <div className="px-5 sm:px-6 pb-2 ">
                          <p className="max-w-[670px] text-[16px] leading-[1.6] text-[#324353]">
                            {faq.answer}
                          </p>
                        </div>
                      </motion.div>
